...
import { C as stripLiteral, w as MagicString } from "../_build/common.mjs";
...
function patchViteClientPlugin() {
	let viteClientPath;
	try {
		viteClientPath = normalizePath(fileURLToPath(import.meta.resolve("vite/dist/client/client.mjs")));
	} catch {
		return null;
	}
