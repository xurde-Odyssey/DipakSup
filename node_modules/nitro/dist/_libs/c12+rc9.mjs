...
import { Y as findWorkspaceDir, Z as readPackageJSON, at as resolveModulePath, ct as dirname$1, dt as join$1, ft as normalize$1, lt as extname$1, mt as resolve$1, st as basename$1 } from "../_build/common.mjs";
...
let importCounter = 0;
const ASYNC_LOADERS = {
	".yaml": () => import("../_build/common.mjs").then((n) => n.tt).then((r) => r.parseYAML),
	".yml": () => import("../_build/common.mjs").then((n) => n.tt).then((r) => r.parseYAML),
	".jsonc": () => import("../_build/common.mjs").then((n) => n.nt).then((r) => r.parseJSONC),
	".json5": () => import("../_build/common.mjs").then((n) => n.it).then((r) => r.parseJSON5),
	".toml": () => import("../_build/common.mjs").then((n) => n.$).then((r) => r.parseTOML)
};
