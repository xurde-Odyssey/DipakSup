...
async function rules(client, argv) {
  if (argv.length === 0) {
    const lsFn = (await import("./ls-THDT5E4M.js")).default;
    return lsFn(client, []);
  }
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-THDT5E4M.js")).default(client, args);
    case "add":
      return (await import("./add-FAIIANHS.js")).default(client, args);
    case "inspect":
      return (await import("./rule-inspect-33M2FHDU.js")).default(client, args);
    case "rm":
      return (await import("./rm-MOVL4G2Y.js")).default(client, args);
    case "update":
      return (await import("./update-CSKHHR3E.js")).default(client, args);
    default:
